...
- `parser.py`: parse ATPG stdout/log summaries into structured records.
...
- Add controlled white-box optimization stages for compaction policy, fault ordering, and adaptive backtrack budgets while keeping ATPG runs as the signoff oracle.
